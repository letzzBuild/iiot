...
export default function AlertDialog(props) {
  ...
  return (
    <div>
      <Button startIcon={props.icon} onClick={handleClickOpen} style={{ backgroundColor: "grey", color: "white", fontWeight: "bold", padding: 8, top: "50px" }}>
        {props.buttonText}
      ...
      >
        ...
        <DialogActions>
          <Button onClick={handleClose} style={{ backgroundColor: "#d50000", color: "white", fontWeight: 'bold', padding: 12, right: "25px", bottom:"7px"}}>
            Cancel
          </Button>
          <Button onClick={shutdown} style={{ backgroundColor: "#1a5f1a", color: "white", fontWeight: 'bold', padding: 12, right: "237px", bottom:"7px"}} autoFocus>
            Yes !!
          </Button>
        </DialogActions>
      </Dialog>
